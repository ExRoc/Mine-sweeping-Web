...
$(document).ready(function() {
    ...
    $("#statistics").click(function() {
        ...
        set_board_html(true);
        $("#new_game").animate({opacity: "0.0"});
        $("#option_data").animate({opacity: "0.0"});
    ...
    $("#statistics_data").click(function() {
        ...
        set_new_game_html(true);
        $("#statistics_data").animate({opacity: "0.0"})
        $("#new_game").animate({opacity: "1.0"});
    });
    ...
    $("#option").click(function() {
        ...
        $("#new_game").animate({opacity: "0.0"});
        $("#statistics_data").animate({opacity: "0.0"})
        $("#option_data").animate({opacity: "1.0"});
    });
